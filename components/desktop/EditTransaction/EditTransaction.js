...
const EditTransaction = ({ data }) => {
   const date = moment(data.date.user || data.date.original).format('MMM, D YYYY')
         ...
         <div className="hidden md:flex flex-col bg-theme-gray-200 py-6 px-6">
            <div className="grid grid-cols-4 grid-rows-2 gap-4 ">
               ...
               <div className="col-span-2">
                  <Text labelText={'Description'} label={'floating'} background={'bg-theme-gray-200'} value={description} />
               </div>
               <Amount labelText={'Amount'} label={'floating'} background={'bg-theme-gray-200'} value={data.amount / 100} />
               <Select labelText={'Type'} label={'floating'} data={[]} background={'bg-theme-gray-200'} />
               <div className="col-span-2">
                  <Select labelText={'Category'} label={'floating'} data={[]} background={'bg-theme-gray-200'} value={data.category} />
               </div>
