   ...
   return (
      <>
         <div className="hidden md:flex flex-col border-t border-theme-gray-600 bg-theme-gray-200 py-6 px-6">
            <div className="grid grid-cols-5 lg:grid-cols-4 grid-rows-2 gap-4 ">
               <Date labelText={'Date'} label={'floating'} background={'bg-theme-gray-200 col-span-2 lg:col-span-1'} value={date} setValue={setDate} error={dateError} setError={setDateError} />
               ...
               <Amount labelText={'Amount'} label={'floating'} background={'bg-theme-gray-200 col-span-2 lg:col-span-1'} value={amount} setValue={setAmount} error={amountError} setError={setAmountError} />
               ...
               <Button onClick={handleSubmit} className="w-full col-span-5 lg:col-span-1">Done</Button>
            </div>
