...
import { Card, Button, Alert } from '../../shared'
      ...
      <>
         ...
         <Card className="px-4 py-8 md:py-16 w-full">
            ...
            <div className="flex flex-col items-center">
               ...
               <span className="text-xs font-light text-center w-56">{data.name}</span>
               <Amount defaultValue={data.balance} className={'font-bold text-center text-4xl mt-4'} />
            </div>
