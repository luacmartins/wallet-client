...
const EditCategory = ({ category, parent, handleEdit, handleDelete }) => {
   ...
   return (
      <>
         ...
         {isVisible &&
            <>
               <div ref={ref} className="fixed bottom-0 sm:bottom-1/2 sm:left-1/2 sm:transform sm:-translate-x-1/2 sm:w-96 sm:rounded-lg left-0 w-full bg-white text-theme-gray-900 px-5 py-4 z-10 sm:z-20">
               ...
               <div className="hidden sm:flex fixed inset-0 bg-theme-gray-700 opacity-75 sm:z-10"></div>
            </>
         }
      </>
   );
